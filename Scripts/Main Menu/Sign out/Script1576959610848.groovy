...
WebUI.click(findTestObject('Object Repository/Page_Town Square - team 1 Mattermost/svg'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - team 1 Mattermost/button_Logout'))
