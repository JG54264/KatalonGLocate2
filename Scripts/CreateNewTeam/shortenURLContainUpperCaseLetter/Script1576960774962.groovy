...
WebUI.setText(findTestObject('Page_Mattermost/input_Team Name_teamNameInput'), 'this is me')

WebUI.sendKeys(findTestObject('Page_Mattermost/input_Team Name_teamNameInput'), Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Page_Mattermost/input_httpmattermost-heroku-testherokuappco_309041'), 'this-is-mE')
