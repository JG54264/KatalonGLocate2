...
WebUI.click(findTestObject('Object Repository/Page_Town Square - team 3 Mattermost/svg'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - team 3 Mattermost/img_People_emoji-1f621'))
