...
WebUI.setText(findTestObject('Page_Town Square - this is me Mattermost/input_Name_newChannelName'), 'hahaha')

WebUI.click(findTestObject('Page_Town Square - this is me Mattermost/span_Edit'))

WebUI.setText(findTestObject('Page_Town Square - this is me Mattermost/input_httpmats-mechannels_form-control'), 'hi')
