...
WebUI.setText(findTestObject('Page_Town Square - this is me Mattermost/input_Name_newChannelName'), 'chotoiditheo')

WebUI.click(findTestObject('Page_Town Square - this is me Mattermost/span_Edit'))

WebUI.setText(findTestObject('Page_Town Square - this is me Mattermost/input_httpmats-mechannels_form-control'), 'chotoilangthang')

WebUI.click(findTestObject('Page_Town Square - this is me Mattermost/span_Change Channel URL'))
