...
WebUI.click(findTestObject('Page_Town Square - this is me Mattermost/span_View and Logout of Active Sessions'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - this is me Mattermost/span_Logout'))

WebUI.setText(findTestObject('Object Repository/Page_ Mattermost - Session Expired/input__loginId'), 'cabcaber')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_ Mattermost - Session Expired/input__password'), 'Ax++UeJEJOMdo+ATQUlG7R+/7ExWYIqDwSMYZeNULQQzQQL5Wywj9g==')

WebUI.click(findTestObject('Object Repository/Page_ Mattermost - Session Expired/button_Sign in'))
