...
WebUI.click(findTestObject('Page_Town Square - this is me Mattermost/span'))
...
WebUI.setText(findTestObject('Page_Town Square - this is me Mattermost/input_Username_username'), 'dnhuyapcs')
...
WebUI.click(findTestObject('Page_Town Square - this is me Mattermost/button_Logout'))

WebUI.setText(findTestObject('Page_Mattermost/input_All team communication in one place s_703ef5'), 'dnhuyapcs')
...
WebUI.setText(findTestObject('Page_Town Square - this is me Mattermost/input_Username_username'), 'cabcaber')
