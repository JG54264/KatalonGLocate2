...
WebUI.click(findTestObject('Object Repository/Page_Town Square - this is me Mattermost/button_Security'))

WebUI.click(findTestObject('Page_Town Square - this is me Mattermost/span_Edit'))

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Town Square - this is me Mattermost/input_Current Password_currentPassword'), 
    'Ax++UeJEJOMdo+ATQUlG7R+/7ExWYIqDwSMYZeNULQSGG7VcGXISsg==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Town Square - this is me Mattermost/input_New Password_newPassword'), 
    'RigbBhfdqODKcAsiUrg+1Q==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Town Square - this is me Mattermost/input_Retype New Password_confirmPassword'), 
    'RigbBhfdqODKcAsiUrg+1Q==')
