...
WebUI.setText(findTestObject('Page_Town Square - this is me Mattermost/input_First Name_firstName'), 'huy')

WebUI.setText(findTestObject('Page_Town Square - this is me Mattermost/input_Last Name_lastName'), 'do')
